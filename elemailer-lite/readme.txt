...
Elemailer is an Elementor addon to create Email templates. It gives you the most flexible design environment to design emails through drag and drop builder- Elementor. Design beautiful emails without any code
...
Elemailer Lite is an <strong>Email template & Campaign builder</strong> using <strong>Drag & Drop Elementor builder.</strong>
...
You must have [Elementor Page Builder](https://wordpress.org/plugins/elementor/) installed. To design your email template with our plugin

👉 [Official Website of Elemiler](https://elemailer.com/). 
👉 [Join Elemailer Facebook Community](https://www.facebook.com/groups/4824705354208369). 
👉 [Elemailer Documentation](https://elemailer.com/documentation/). 


==List of Supported Form Plugins: ==

1. [Contact Form 7:](https://wordpress.org/plugins/contact-form-7/) Design your contact form 7 emails without any code. Find out more: [How to Design Contact Form 7 Email template? ](https://elemailer.com/now-you-can-edit-your-contact-form-7-email-using-elementor/) 
You should have [Contact Form 7](https://wordpress.org/plugins/contact-form-7/) installed & activated if you want to design cf7 email templates with Elemailer


2. [Elementor Pro's Form Widget:](https://elementor.com/pro/) You can design Elementor Pro's form widget's email and email2 layout with Elemailer Lite. 
You should have [Elementor Pro](https://elementor.com/pro/) installed if you want to use Elemailer template in your Elementor Pro's forms response
...
<blockquote>
<strong>The free version is enough for many users who are just looking to design their Elementor pro form or contact form 7's email template (basic). But if you are a marketer or want to do more with your Email template design we invite you to check our pro version - <a target="_blank" href="https://elemailer.com">Elemailer</a></strong>
...
[youtube https://youtu.be/7_8P3rM0KTM]


[youtube https://youtu.be/TaJkgK4bVgA]

See the AI in action: 
[youtube https://youtu.be/HJMfsYHBLKs]
...
The Email AI system that is used in Elemailer is the [Elementor's AI API](https://elementor.com/products/ai/). It's free for use and the amount of prompts is more than enough for basic uses. The limit is not well mentioned but [this](https://elementor.com/terms/elementor-ai-terms-and-conditions/) can give you some idea. According to our test the limit is probably around 7,000 Words. But if you need more for some reason or want to use it in your website design too, they offer additional credit purchase on demand for a relatively low price per month. 
...
Keep in mind when generating text, code or images, you may want to use multiple prompts until you reach your desired result.
...
1. Create your form email template
2. Create the email layout with Elementor builder
3. In your Elementor pro form, select Elemailer template
4. Use the Prebuilt Email Template library
5. Import from Email Template library
6. The pro version allows more settings & Control along with Test emails
7. Use Elementor AI to generate content for Free*
8. Use AI to generate Image Email templates
9. AI to edit Email images
...
= 2.4 =
* Fix: Compatilbity with latest wp release and elementor fatal error
= 2.3 =
